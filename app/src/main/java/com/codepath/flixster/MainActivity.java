...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // create movie  adapter with movies
        final MovieAdapter movieAdapter = new MovieAdapter(this, movies);
        // add the adapter into recycle view
        ...
        client.get(NOW_PLAYING, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Headers headers, JSON json) {
                ...
                try {
                    ...
                    movies.addAll(Movie.fromJsonArray(results)); // movies object list is here
                    movieAdapter.notifyDataSetChanged();
                    Log.i(TAG,"Movies: " + movies.size());

                } catch (JSONException e) {
                    Log.e(TAG, "Hit JSON failure",e);
                }
